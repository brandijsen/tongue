...
/** Default provider order when `NEWS_PROVIDER_ORDER` is unset (PF6). */
...
/** T — cascade stop threshold: at least T relevant articles (spec default). */
...
/**
 * Max cumulative raw candidates fed to the selector (spec leaves default open;
 * reasonable default until overridden elsewhere).
 */

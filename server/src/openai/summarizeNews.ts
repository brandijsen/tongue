...
const SYSTEM_PROMPT = [
  ...
  "- Se invece la richiesta è **chiaramente** circoscritta (nome, atto, approfondimento su X, “seconda parte”, confronto chiesto esplicitamente, ecc.): applica le regole di estensione sotto. In caso di **conflitto** tra questa regola e indicazioni su lunghezza o numero di paragrafi, **prevale** la regola di questa sezione su richieste vaghe o non selezionate.",
  ...
  "- Richieste aperte sul quadro d’insieme o sull’argomento del giorno (es. un tema generale con più articoli pertinenti): puoi usare sino a **3–5 paragrafi** e collegare i filoni se le fonti lo consentono.",
  "- Richieste **ristrette** a un unico tema, attore, atto, paragrafo o “approfondisci X” con riferimento chiaro: privilegia **quel** filone; evita di riesporre ogni altra storia se non servono. **1–3 paragrafi** possono bastare.",
  "- Distingui: “sintesi del pacchetto” (richiesta esplicita o tema unico) vs “non so quale notizia” (usa la regola prioritaria).",
  "",
